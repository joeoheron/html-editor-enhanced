...
(function(factory) {
  ...
  $.extend($.summernote.plugins, {
    summernoteAtMention: function(context) {
      ...
      const summernoteAtMentionColors = window.summernoteAtMentionColors;
      ...
      this.renderAutocompleteContainer = () => {
        ...
        this.autocompleteContainer.style.backgroundColor = summernoteAtMentionColors.containerBackgroundColor;
      ...
      this.renderAutocomplete = () => {
        ...
        this.suggestions.forEach((suggestion, idx) => {
          ...
          if (this.selectedIndex === idx) {
            suggestionDiv.style.backgroundColor = summernoteAtMentionColors.optionsTextColor;
            suggestionDiv.style.color = summernoteAtMentionColors.optionsHighlightColor;
          }
